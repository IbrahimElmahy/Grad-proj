...
class YoloDetectorModelTests(SimpleTestCase):
    ...
    def test_get_models_loads_all_available_model_weights(self, mock_yolo):
        ...
        expected_paths = [
            os.path.join("C:\\Users\\User\\OneDrive\\Desktop\\Grad-proj-main", "backend", "ai_engine", "models", "best.pt"),
            os.path.join("C:\\Users\\User\\OneDrive\\Desktop\\Grad-proj-main", "backend", "ai_engine", "models", "best_4c.pt"),
            os.path.join("C:\\Users\\User\\OneDrive\\Desktop\\Grad-proj-main", "backend", "ai_engine", "models", "best_7c.pt"),
        ]
